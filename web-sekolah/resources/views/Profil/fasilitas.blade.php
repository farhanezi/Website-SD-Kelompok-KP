...
@section('description', 'Fasilitas SDN Dadapsari — ruang kelas, sarana prasarana, dan media pembelajaran digital.')
...
<style>
    ...
    .fas-header h1 { font-size: clamp(1.8rem, 4vw, 2.6rem); font-weight: 800; margin: .4rem 0 .6rem; position: relative; }
    .fas-header p  { max-width: 640px; margin: 0 auto; color: rgba(255,255,255,.8); position: relative; }
    ...
    .rk-ket { font-size: .85rem; color: var(--muted); line-height: 1.55; }
    ...
    .video-card {
        background: var(--white); border-radius: var(--radius); box-shadow: var(--shadow);
        overflow: hidden; border-top: 4px solid #ef4444;
        transition: transform .25s ease, box-shadow .25s ease;
        display: flex; flex-direction: column;
    }
    ...
    .video-thumb .play-btn {
        ...
        background: rgba(239,68,68,.9); display: grid; place-items: center;
    ...
    /* ── EMPTY STATE ── */
    .empty-state {
        background: var(--white); border: 1.5px dashed #cbd5e1;
...
<section class="fas-header">
    <span class="eyebrow">Profil Sekolah</span>
    <h1>Fasilitas SDN Dadapsari</h1>
    <p>Informasi lengkap ruang kelas, jumlah siswa, sarana prasarana, dan media pembelajaran digital SDN Dadapsari.</p>
</section>

{{-- School photo banner --}}
<div class="fas-photo-banner">
    <img src="{{ asset('images/sekolah-2.jpeg') }}" alt="Fasilitas SDN Dadapsari">
</div>
                        ...
                        @foreach ($videos as $vid)
                            <div class="video-card">
                                ...
                                <div class="video-body">
                                    ...
                                    <a href="{{ $vid->url_video }}" target="_blank" rel="noopener" class="video-btn">▶ Tonton Video</a>
                                </div>
                            </div>
                        @endforeach
                    </div>
